...
const Checkout2 = () => {
    ...
    const checkoutHeader1 = (
        <div className='w-full md1:w-[80%] md1:m-auto border'>
    ...
    const checkoutHeader2 = (
        <>
        <div className='my-4 relative z-[1] bg-gray-100 md1:w-[80%] m-auto'>
            <div className='absolute z-[2] left-[15%] right-[15%] top-[18px] border border-gray-400 md1:w-[480px] m-auto'></div>            
            <div className='relative z-[3] my-4 flex justify-around w-full md1:w-[700px] md1:m-auto'>
